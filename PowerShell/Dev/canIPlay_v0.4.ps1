...
while ($true) {
    ...
    $googleDNS_1_ping = (Test-Connection -TargetName $googleDNS_1 -Count 1 -ErrorAction SilentlyContinue).Latency;
    $googleDNS_2_ping = (Test-Connection -TargetName $googleDNS_2 -Count 1 -ErrorAction SilentlyContinue).Latency;
    $openDNS_1_ping = (Test-Connection -TargetName $openDNS_1 -Count 1 -ErrorAction SilentlyContinue).Latency;
    $openDNS_2_ping = (Test-Connection -TargetName $openDNS_2 -Count 1 -ErrorAction SilentlyContinue).Latency;
